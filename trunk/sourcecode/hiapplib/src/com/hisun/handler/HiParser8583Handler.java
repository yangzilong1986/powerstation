   ...
   implements IHandler, IServerInitListener
 {
   ...
   public void process(HiMessageContext ctx) throws HiException {
     ...
     if (StringUtils.equals(this.version, "2"))
       if ((headRoot != null) && (plainBytes.charAt(0) != 48))
       {
     ...
     if (this.log.isInfoEnabled())
       this.log.info(this.sm.getString("HiParser8583Handler.parsered"));
   }
   ...
   private String makeEtfItem(ByteArrayInputStream in, HiETF etfBody, int idx, Element cfgRoot) throws HiException
   {
     ...
     else if (length_type.equals("VAR2"))
       length = getHeadLen(in, 2, item);
     else if (length_type.equals("VAR3"))
       length = getHeadLen(in, 3, item);
     else {
     ...
     throws HiException
   {
     ...
     if (this.log.isInfoEnabled())
       this.log.info(this.sm.getString("HiParser8583Handler.parserTlvOk", field_id));
   }
     ...
     throws HiException
   {
     ...
     if (this.log.isInfoEnabled())
       this.log.info(this.sm.getString("HiParser8583Handler.init2", this.cfgFile));
   }
