...
public class HiIterator extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (this.offset == null) this.offsetValue = 0;
            ...
            try {
                ...
                if (offsetObject == null) this.offsetValue = 0;
        ...
        if (this.length == null) this.lengthValue = 0;
            ...
            try {
                ...
                if (lengthObject == null) this.lengthValue = 0;
