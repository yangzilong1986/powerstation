...
public class HiSelectTag extends BodyTagSupport implements DynamicAttributes {
    private String code;
    private String sql;
    ...
    public int doEndTag() throws JspException {
        ...
        if (!(StringUtils.isBlank(this.code))) try {
    ...
    public LinkedHashMap processByCode(String code, String param) throws Exception {
        ...
        if (param != null) {
            ...
            root = HiETFFactory.createETF(param);
        ...
        for (int i = 0; ; ++i) {
            ...
            HiETF grpNod = root.getChildNode("GRP_" + (i + 1));

            if (grpNod == null) break;
            if (grpNod.isEndNode()) {
