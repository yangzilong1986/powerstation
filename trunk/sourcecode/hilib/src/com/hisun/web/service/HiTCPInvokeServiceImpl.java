...
public class HiTCPInvokeServiceImpl implements IInvokeService {
    private String ip;
    private int port;
    private int tmOut;
    ...
    public HiMessage invoke(HiMessage msg) throws HiException {
        ...
        if (this.logSwitch) msg.setHeadItem("STF", "1");
    ...
    public static int read(InputStream in, OutputStream out, int prelen) throws IOException {
