...
public class HiClientUtilPOJO {
    public static void start(String serverName) throws HiException {
    ...
    private static void invoke(HiMessage msg, String jndi) throws HiException {
        ...
        try {
            ...
            if (o == null) {
                ...
                HiStartup startup = new HiStartup("");
    ...
    private static void invoke(HiMessage msg, String factoryName, String queueName) throws HiException {
    ...
    public static void invoke(String method, String serverName, String groupName, String configFile, String type) throws HiException {
        ...
        if (StringUtils.equalsIgnoreCase(type, "jms")) {
            ...
            if (!(StringUtils.equalsIgnoreCase(serverName, "S.MDBSVR"))) {
                ...
                queueName = HiSYSCFG.getInstance().getProperty("_QUEUE");

                int idx = queueName.lastIndexOf("Queue");

                if (idx != -1) {

                    queueName = queueName.substring(0, idx) + serverName;
                }
            }
