...
public class HiIbatisProvider extends HiJDBCProvider implements DataAccessProvider {
    ...
    public void close() {
        ...
        if ((this._sessions != null) && (!(this._sessions.isEmpty()))) this._sessions.remove(this._dsName);
