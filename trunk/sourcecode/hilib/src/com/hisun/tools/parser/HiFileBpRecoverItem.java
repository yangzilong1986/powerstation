...
public class HiFileBpRecoverItem {
    ...
    public void setDevice(String device) {
        ...
        if (StringUtils.equalsIgnoreCase(device, "hd")) this._device = 1;

        else if (StringUtils.equalsIgnoreCase(device, "rd")) this._device = 0;

        else if (StringUtils.equalsIgnoreCase(device, "hr")) this._device = 2;
    ...
    public void setIscompress(String iscompress) {
        ...
        if (StringUtils.equalsIgnoreCase(iscompress, "n")) this._isCompress = false;
    ...
    public void setIsoverlay(String isoverlay) {
        ...
        if (StringUtils.equalsIgnoreCase(isoverlay, "y")) this._isOverlay = true;
    ...
    public void setIsclean(String isclean) {
        ...
        if (StringUtils.equalsIgnoreCase(isclean, "n")) this._isClean = false;
    ...
    public void setRecoverlastpack(String recoverlastpack) {
        ...
        if (StringUtils.equalsIgnoreCase(recoverlastpack, "n")) this._recoverLastPack = false;
    ...
    private void backupToHd(String srcDir, String destDir, boolean isCompress, boolean isOverLay, String type, String date) throws Exception {
        ...
        for (int i = 0; i < tmps.length; ++i) {
            ...
            if (workdir.endsWith("/")) tmp.append(workdir + tmps[i]);
    ...
    private void backupToRd(String tape, String srcDir, String destDir, boolean isCompress, boolean isOverLay, String type, String date) throws Exception {
    ...
    private void restoreFromHd(String srcDir, String destDir, boolean isCompress, boolean isOverLay, String type, String date) throws Exception {

    }


    private void restoreFromRd(String tape, String srcDir, String destDir, boolean isCompress, boolean isOverLay, String type, String date) throws Exception {
