...
public class JavaCharStream {
    ...
    protected void FillBuff() throws IOException {
        if (this.maxNextCharInd == 30) this.maxNextCharInd = (this.nextCharInd = 0);
        try {
            int i;
    ...
    protected void AdjustBuffSize() {
        if (this.available == this.bufsize) if (this.tokenBegin > 15) {
            this.bufpos = 0;
        ...
        else if (this.tokenBegin - this.available < 15) ExpandBuff(true);
    ...
    public char readChar() throws IOException {
        ...
        if ((this.buffer[this.bufpos] = c = ReadByte()) == '\\') {
            ...
            int backSlashCnt = 1;
            while (true) {
                if (++this.bufpos == this.available) AdjustBuffSize();
                try {
                    if ((this.buffer[this.bufpos] = c = ReadByte()) != '\\') {
                        UpdateLineColumn(c);
