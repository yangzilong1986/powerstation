...
public class HiCicsCliSyncHandler implements IHandler, IServerInitListener {
    ...
    public void process(HiMessageContext ctx) throws HiException {
        ...
        if (this.log.isDebugEnabled()) this.log.debug("HiCicsCliSyncHandler process:end");
    }
    ...
    public void serverInit(ServerEvent arg0) throws HiException {
        ...
        if (this.log.isDebugEnabled()) this.log.debug("HiCicsCliSyncHandler serverInit:end");
    }
}