...
public class TxHistory {
    ...
    public int GenInfDetail(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        ...
        String opt_type = "";
        if ((newAreaExist) && (oldAreaExist)) opt_type = "M";
        else if (newAreaExist) opt_type = "A";
        else {
            opt_type = "D";
        }
    ...
    public int GenInfDetailBySQL(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
    ...
    public int RecordInfDetail(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage msg = ctx.getCurrentMsg();
        Logger log = HiLog.getLogger(msg);
    ...
    public int RecordInfMain(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage msg = ctx.getCurrentMsg();
        Logger log = HiLog.getLogger(msg);
