...
public class SwitchATC {
    ...
    public int getRecGrpCount(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
    ...
    public int createCWA(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage mess = ctx.getCurrentMsg();
        HiETF etfRoot = (HiETF) mess.getBody();
    ...
    public int createGWA(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage mess = ctx.getCurrentMsg();
        HiETF etfRoot = (HiETF) mess.getBody();
    ...
    public int combineETF(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage mess = ctx.getCurrentMsg();
        HiETF etfRoot = (HiETF) mess.getBody();
    ...
    public int copyGroup(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage mess = ctx.getCurrentMsg();
        HiETF etfRoot = (HiETF) mess.getBody();
        Logger log = HiLog.getLogger(mess);
    ...
    public int DEBUG(HiATLParam argsMap, HiMessageContext ctx) throws HiException {
        HiMessage mess = ctx.getCurrentMsg();
        HiETF etfRoot = (HiETF) mess.getBody();
        Logger log = HiLog.getLogger(mess);
