...
public class HiLogIDHandler implements IHandler, IServerInitListener {
    ...
    public void process(HiMessageContext arg0) throws HiException {
        ...
        if (logIDMap.containsKey(id)) {
            ...
            if (StringUtils.isNotBlank(value)) msg.setHeadItem("STF", value);
        }
    }
    ...
    public void serverInit(ServerEvent arg0) throws HiException {
        ...
        if ((this.offset == 0) || (this.length == 0)) throw new HiException("213307", "offset|length");
    }
}