...
public class HiBodyTypeConvert implements IHandler {
    public void etf2bb(HiMessageContext ctx) throws HiException {
    ...
    public void bb2etf(HiMessageContext ctx) throws HiException {
        HiMessage msg = ctx.getCurrentMsg();
        Object o = msg.getBody();
    ...
    public void etf2dom(HiMessageContext ctx) throws HiException {
        HiMessage msg = ctx.getCurrentMsg();
    ...
    public void dom2etf(HiMessageContext ctx) throws HiException {
        HiMessage msg = ctx.getCurrentMsg();
    ...
    public void process(HiMessageContext ctx) throws HiException {
        ...
        if (StringUtils.equals(sch, "rq")) etf2dom(ctx);
        else dom2etf(ctx);
    }
}