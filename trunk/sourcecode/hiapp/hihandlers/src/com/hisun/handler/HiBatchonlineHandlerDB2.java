...
public class HiBatchonlineHandlerDB2 implements IHandler, IServerInitListener, IServerStartListener, IServerStopListener, IServerPauseListener, IServerDestroyListener, IServerResumeListener {
    ...
    public void process(HiMessageContext ctx) throws HiException {
        ...
        while (true) {
            ...
            if (this._serverType.equals("B")) checkServerTypeForB(dbUtil, actDat);
            else {
    ...
    private int checkServerTypeForB(HiDataBaseUtil dbUtil, String actDat) throws HiException {
        int ret = 0;
        try {
    ...
    private int checkServerTypeForA(HiDataBaseUtil dbUtil, String actDat) throws HiException {
        int ret = 0;
        try {
    ...
    private void sendRecord(HiMessageContext ctx, HiPubBatchInfo batchInfo, String sysId) throws HiException {
        ...
        try {
            ...
            while (this._status != 1) {
                ...
                if (msg.getHeadItem("STF") != null) newMsg.setHeadItem("STF", msg.getHeadItem("STF"));
                else {
    ...
    class BatchOnlineProcess implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (ctx.getDataBaseUtil() != null) ctx.getDataBaseUtil().close();
            }
        }
            ...
            for (i = 0; i < 1; ++i) {
                if ((!(StringUtils.equalsIgnoreCase(aHTxnSt, "S"))) && (!(StringUtils.equalsIgnoreCase(aHTxnSt, "F")))) {
                    synchronized (HiBatchonlineHandlerDB2.this._lock) {
                        label585:
                        HiBatchonlineHandlerDB2.access$408(HiBatchonlineHandlerDB2.this);
                    }
                }
