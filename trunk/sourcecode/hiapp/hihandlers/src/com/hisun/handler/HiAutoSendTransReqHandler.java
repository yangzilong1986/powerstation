...
public class HiAutoSendTransReqHandler implements IServerInitListener, IServerStartListener, IServerStopListener {
    ...
    public void serverStop(ServerEvent arg0) throws HiException {
        if ((this.thd != null) && (this.thd.isAlive())) this.thd.interrupt();
    }
    ...
    class HiAutoTriggerTrans implements Runnable {
        public void run() {
