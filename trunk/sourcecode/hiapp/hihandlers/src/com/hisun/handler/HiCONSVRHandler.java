...
public class HiCONSVRHandler implements IHandler, IServerInitListener {
    ...
    public void doRequest(HiMessageContext ctx) throws HiException {
    ...
    public void doResponse(HiMessageContext ctx) throws HiException {
        HiMessage msg1 = ctx.getCurrentMsg();
    ...
    public void serverInit(ServerEvent arg0) throws HiException {
        if (!(StringUtils.isNotBlank(this._regionRouter))) return;
    ...
    private void loadRegionRouter(String regionRouter) throws HiException {
        ...
        if (url == null) throw new HiException("213302", regionRouter);
        try {
