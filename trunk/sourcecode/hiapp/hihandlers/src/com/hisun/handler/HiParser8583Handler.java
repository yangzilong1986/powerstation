...
public class HiParser8583Handler implements IHandler, IServerInitListener {
    ...
    public void process(HiMessageContext ctx) throws HiException {
        ...
        if (this.log.isInfoEnabled()) {
            this.log.info(this.sm.getString("HiParser8583Handler.parser0"));
            this.log.info(this.sm.getString("HiParser8583Handler.parser1", plainBytes.toString()));

            this.log.info(this.sm.getString("HiParser8583Handler.parser2", HiConvHelper.bcd2AscStr(plainBytes.getBytes())));
        }
        ...
        if (this.log.isInfoEnabled()) this.log.info(this.sm.getString("HiParser8583Handler.parsered"));
    }

    public HiETF convertHeaderToETF(ByteArrayInputStream in, HiETF etfBody, Element headRoot) throws HiException {
        if (this.log.isInfoEnabled()) {
    ...
    public HiETF convertToETF(ByteArrayInputStream in, HiETF etfBody, Element cfgRoot) throws HiException {
    ...
    private String getBitMap(ByteArrayInputStream in, HiETF etfBody, int idx) throws HiException {
        if (this.log.isInfoEnabled()) {
            this.log.info(this.sm.getString("HiParser8583Handler.getBitMap0"));
        }
        ...
        if (this.log.isInfoEnabled()) {
            this.log.info(this.sm.getString("HiParser8583Handler.getBitMap1", hexStr));
        }
    ...
    private String makeEtfItem(ByteArrayInputStream in, HiETF etfBody, int idx, Element cfgRoot) throws HiException {
        ...
        if (ArrayUtils.indexOf(this.tlvFldList, idx) >= 0) {
            ...
            if (this.log.isInfoEnabled()) {
                this.log.info(this.sm.getString("HiParser8583Handler.parserItem1", String.valueOf(idx), itemName, String.valueOf(length), data_value));
            }
    ...
    private String readBcd(ByteArrayInputStream in, int length, int radix, Element itemNode) throws HiException {
    ...
    private int getHeadLen(ByteArrayInputStream in, int varLen, Element itemNode) throws HiException {
    ...
    private void parserTlvItem(HiETF etfBody, Element itemNode, ByteArrayInputStream bIn) throws HiException {
        if (this.log.isDebugEnabled()) {
    ...
    public void serverInit(ServerEvent arg0) throws HiException {
        if (this.log.isInfoEnabled()) {
            this.log.info(this.sm.getString("HiParser8583Handler.init1", this.cfgFile));
        }
        ...
        if (this.log.isInfoEnabled()) this.log.info(this.sm.getString("HiParser8583Handler.init2", this.cfgFile));
    }
