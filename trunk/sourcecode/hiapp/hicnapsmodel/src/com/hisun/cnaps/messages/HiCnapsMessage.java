...
public class HiCnapsMessage {
    ...
    public HiCnapsMessageArea getMessageBusArea(int i) {
        if (i < 0) throw new IllegalArgumentException(String.valueOf(i));
    ...
    public HiCnapsMessageArea createMessageBodyArea(String[] fileds, String[] optfileds, HiETF etf) throws HiException {
