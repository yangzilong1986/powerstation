...
<html>
  ...
  <meta http-equiv="pragma" content="no-cache"/>
   ...
   <body onload="pfInit()">
    <html:form action="/do/autorm/pfQuery" method="post">
      ...
      <div id="main">
          ...
          <div id="tool">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td colspan="4"><bean:message bundle="autorm" key="autorm.dataquery.lable.help.glyscx"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="220" class="dom"><peis:selectlist name="dateType" sql="QUERY0011" onChange="pfDTChange()"/></td>
        ...
        <div class="content">
          <div id="cont_3">
            <div class="target">
              <ul>
                <li class="target_on" id="show1"><a href="#"><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj"/></a></li>
                <li class="clear"></li>
              </ul>	
            </div>
            <div class="tableContainer" style="height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 172));">
                    <table id="data_table" align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
                     ...
                     <tr id="QUERY_TR_1" style="display: none">
				         ...
				         <th width="180px"><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj1"/></th>
				         <th width="180px"><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj2"/></th>
				         <th width="180px"><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj3"/></th>
		         ...
		         <logic:iterate id="datainfo" name="PG_QUERY_RESULT">
		            <tr>
				         ...
				         <td id="LINE_TD_1" style="display: none">
				            <a href="javascript:pfDetail(900,450,'<bean:write name="datainfo" property="col7"/>','<bean:write name="datainfo" property="col8"/>','<bean:write name="datainfo" property="col1"/>',2)"><bean:message bundle="autorm" key="autorm.dataquery.lable.ckqx"/></a></td>
				         <td id="DAY_TD_1" style="display: none">
				            <a href="javascript:pfDetail(900,600,'<bean:write name="datainfo" property="col7"/>','<bean:write name="datainfo" property="col8"/>','<bean:write name="datainfo" property="col1"/>',3)"><bean:message bundle="autorm" key="autorm.dataquery.lable.ckrsj"/></a></td>
		            </tr>
		         </logic:iterate>
                 </logic:present>
                 </tbody>
            ...
            <div class="pageContainer" id="PAGE_DAY" style="display: ;">
              <peis:pagination sql="QUERY0022" queryActionPath="do/autorm/pfQuery" allowRowsChange="true"/>
            </div>
          </div>
        </div>
      </div>
