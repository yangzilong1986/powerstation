            ...
            jQuery.ajax({
                ...
                success:function(json){
                    ...
                    if(msg=="1"){
                       alert("保存成功");
                       parent.GB_hide();
                       top.getMainFrameObj().mainframe.contentArea.location.href=contextPath+"/archive/gmList4Query.do?action=normalMode&sqlCode=AL_ARCHIVE_0023&termId="+termId+"&pageRows=20";
                    }else if(msg=="2"){
                       alert("资产编号已经存在");
                    }else{
                       alert("保存失败");
