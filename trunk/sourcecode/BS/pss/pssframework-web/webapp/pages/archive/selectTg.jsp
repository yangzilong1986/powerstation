...
function nextStep(){
    ...
    if(tgId==null){
      ...
      window.location.href=contextPath+"/archive/addTgAction.do?action=forwardToEditTgDeviceInfo&tgId="+tgId;
    }
}
//输入框文字效果
         ...
         $.ajax({
            ...
            success: function(json){
	            ...
	            if(msg == "1"){
	                ...
	                //window.location.href = contextPath + "/archive/tgListQuery1.do?action=normalMode&sqlCode=AL_ARCHIVE_0028";
...
function exprotexcel(){
    var url = contextPath+"/archive/tgListQuery1.do?action=exportExcel&" 
...
<body>
<html:form action="/archive/tgListQuery1" method="post">
