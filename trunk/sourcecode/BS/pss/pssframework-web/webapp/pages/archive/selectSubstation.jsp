...
$(document).ready(function(){
    autoCompleter("czmc","43",154);
});
</script>
</head>
<body onload="loadVols('${ETF.VOLT_GRADE}')">
<form action="112041.dow" method="post" name="sta"> 
<div id="body">
   <jsp:include page="archiveTabs.jsp" flush="true">
	...
	<div id="main">
      ...
      <table border="0" cellpadding="0" cellspacing="0" >
         <tr>
           <td width="70" class="label" align="center">变电站：</td>
           <td width="180">
		...
		<div class="content">
          ...
          <ul>
            <li class="target_on">
              <a href="#" onclick="setTarget(1); return false;">变电站列表</a>
            </li>
            <li class="clear"></li>
          </ul>
				</div>
				<div class="tableContainer" style="height: expression((( document.documentElement.clientHeight || document.body.clientHeight) -   183 ) ); width:expression((( document.documentElement.clientWidth||document.body.clientWidth)-46 ) );">
					<table border="0" cellpadding="0" cellspacing="0" width="100%"  id="stat">
						<thead>
						<tr>
						  <th>序号</th>
						  <th>变电站编号</th>
	 ...
	 <script language=javascript>
       ...
       var first_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvFirst('112041.dow','WantedPerPage')\"><img style='margin-left:-5;margin-right:7;' src=\"<peis:contextPath/>/img/page_home.gif\" class=\"pointer\"/></a>\n";
       var forward_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvForward('112041.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_prew.gif\" class=\"pointer\"/></a>\n";
       var next_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvNext('112041.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_next.gif\" class=\"pointer\"/></a>\n";
       var end_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvEnd('112041.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_end.gif\" class=\"pointer\"/></a>\n";
       ...
       function getTargetPage(){
        ...
        var targetURL = "112041.dow?WANTEDPERPAGE="+$('#WantedPerPage').val()+"&PAG_KEY="+tempPAG_KEY + "&TIA_TYP=P&PAG_IDX=00"+page+"&VOLT_GRADE="+tempVOLT_GRADE+"&CZMC="+tempCZMC;
      ...
      function padLeft(str,lenght){
       ...
       function changePerRows(){
       		window.location.href="112041.dow?WANTEDPERPAGE="+$("#WantedPerPage").val()+"&PAG_IDX=aa+&PAG_KEY="+tempPAG_KEY+"&CZMC="+tempCZMC+"&VOLT_GRADE="+tempVOLT_GRADE;
       	}
...
function nextStep(){
   ...
   if(tgNo==null){
     ...
     window.location.href="../../jsp/archive/addSubstation.jsp?SUBS_ID="+tgNo
                          +"&PARAM=1&ORG_NO="+tgNo1
                          +"&CZMC="+tempCZMC
...
function deleteTg(param,param1){
   if(confirm("是否删除该变电站")==true){
     $.ajax({
      type:"POST",
      url:"112021.dow",
      dataType:"json",
      data:{SUBS_ID:param,SUBS_NO:param1,SUBS_TYPE:"1"},
...
function creatExcel(){
	//window.location.href="112051.dow?VOLT_GRADE="+tempVOLT_GRADE+"&CZMC="+tempCZMC;

	$.ajax({
      type:"POST",
      url:"112051.dow",
      dataType:"json",
      data:{CZMC:tempCZMC,VOLT_GRADE:tempVOLT_GRADE,FLG:"STATION"},
      success:function(data){
