...
//上一步
 function lastStep(){
   ...
   window.location.href="112034.dow?SUBS_ID="+tempSUBS_ID+"&FLG=QUERY&QUE=1";
    }else{
    	window.location.href="112041.dow?WANTEDPERPAGE="+tempWantedPerPage+"&CZMC="+tempCZMC+"&VOLT_GRADE="+tempVOLT_GRADE;
    }
 }
//完成
 function finish(){
 	if(tempPARAM==''||tempPARAM=="null"){
    if((confirm("是否继续新增变电站")==true)){
	    window.location.href=contextpath+"/jsp/archive/addSubstationDetail.jsp";
	  }
    else{
...
<div id="body">
   ...
   <div id="main">
    ...
    <div class="content">
     <div id="cont_1">
       <div style="border: 1px solid #5d90d7; height: expression((( document.documentElement.clientHeight || document.body.clientHeight)- 137));">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
          <tr>
            <td width="200" valign="top" id="treePanel">
              <iframe name="treeframe" width="100%" height="100%" frameborder="0" scrolling="auto" src="112111.dow?OPEN_NEW=substationTree.jsp&subs_id=<%=request.getParameter("SUBS_ID")%>&PARAM=<%=request.getParameter("PARAM")%>"></iframe>
            </td>
            ...
            <td class="pad10">
             <iframe name="mainframe" width="100%" height="100%" frameborder="0" scrolling="no" src="112034.dow?OPEN_NEW=substation.jsp&subs_id=<%=request.getParameter("SUBS_ID")%>&FLG=QUERY"></iframe>
            </td>
          </tr>
        </table>
     </div>
