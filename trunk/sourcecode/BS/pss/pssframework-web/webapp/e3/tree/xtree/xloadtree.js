...
webFXTreeConfig.loadErrorTextTemplate = "loading error... \"%1%\"";
webFXTreeConfig.emptyErrorTextTemplate = "";//"?????? \"%1%\" ??а??κ? tree ???";

/*
 * WebFXLoadTree class
 */

function WebFXLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sOpen) {
	// call super
