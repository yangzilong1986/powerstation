...
public class FrameC07 extends AbstractFrame {
    ...
    public String getDescription() {
        if (this.frame != null) {
            ...
            sb.append("命令类型--").append("实时设置终端参数");
            sb.append("\n");
    ...
    private void descMastCmd(StringBuffer buffer) {
        try {
            ...
            buffer.append("20").append(Util.ByteToHex(this.frame[16])).append("-").append(Util.ByteToHex(this.frame[17])).append("-").append(Util.ByteToHex(this.frame[18])).append(" ").append(Util.ByteToHex(this.frame[19])).append(":").append(Util.ByteToHex(this.frame[20])).append(":00    ");

            buffer.append("命令有效时间---").append(Util.ByteToHex(this.frame[21])).append("min\n");
