...
//上一步
 function lastStep(){
   ...
   window.location.href="112024.dow?SUBS_ID="+tempSUBS_ID+"&FLG=QUERY&QUE=1";
  }else{
  	window.location.href="112043.dow?WANTEDPERPAGE="+tempWantedPerPage+"&CZMC="+tempCZMC+"&VOLT_GRADE="+tempVOLT_GRADE;
  	}
 }
 ...
 function finish(){
 	if(tempPARAM==''||tempPARAM=="null"){
    if((confirm("是否继续新增开关站")==true)){
	    window.location.href=contextpath+"/jsp/archive/addSwitchStationDetail.jsp";
	  }
    else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
          <tr>
            <td width="200" valign="top" id="treePanel">
              <iframe name="treeframe" width="100%" height="100%" frameborder="0" scrolling="auto" src="112111.dow?OPEN_NEW=selectSwitchTree.jsp&subs_id=<%=request.getParameter("SUBS_ID")%>"></iframe>
            </td>
            ...
            <td class="pad10">
              <iframe name="mainframe" width="100%" height="100%" frameborder="0" scrolling="no" src="112024.dow?OPEN_NEW=switchStation.jsp&subs_id=<%=request.getParameter("SUBS_ID")%>&FLG=QUERY"></iframe>
            </td>
          </tr>
        </table>
     </div>
