...
<html>
 <head>
  ...
  $(document).ready(function(){
    //$('#contentArea').attr("src",contextPath+"/archive/terminalAction1.do?action=updateTermInit&termId="+termId+"&tgId="+tgId+"&flag=1");
    $('#contentArea').attr("src",contextPath+"/archive/terminalAction1.do?action=addTermInit&termId="+termId+"&flag=1");
  });
