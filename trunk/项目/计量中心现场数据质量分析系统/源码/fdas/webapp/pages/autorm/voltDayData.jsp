...
<html>
  ...
  <body>
    <form name="form1" action="<peis:contextPath/>/singleUserQuery.do?action=queryVoltDayData" method="post" onsubmit="return checkForm();">
               ...
               <td width="40%">
                  <div id="tableContainer" class="tableContainer" style="height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 140));">
                    ...
                    <thead><tr>
                       ...
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.axdy"/></th>
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.bxdy"/></th>
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.cxdy"/></th>
                    </tr>
                    </thead>
                    <tbody>
