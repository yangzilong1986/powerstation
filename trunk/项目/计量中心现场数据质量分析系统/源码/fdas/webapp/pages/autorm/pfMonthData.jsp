...
<html>
  ...
  <body>
    <form action="<peis:contextPath/>/do/autorm/dataQuery.do?action=pfMonthData" method="post">
       ...
       <table border="0" cellpadding="0" cellspacing="0" class="function_title">
		<tr>
          ...
          <bean:message bundle="autorm" key="autorm.dataquery.lable.sjsj"/>
             ...
             <input class="input_ok" type="submit" class="bottonStyle_01" value="<bean:message bundle='autorm' key='autorm.dataquery.lable.query'/>"/>
          </td>
		</tr>
      </table>
      <br/>
                  ...
                  <table align="center" width="100%" border="0" cellpadding="0"cellspacing="0">
                    ...
                    <tr>
                      <th><bean:message bundle="autorm" key="autorm.dataquery.lable.no"/></th>
                       ...
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj1"/><br></th>
				       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj2"/></th>
				       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.qdljsj3"/></th>
                    </tr>
                    </thead>
                    <tbody>
