...
<html>
  ...
  <body onload="meterInit()">
    <html:form action="/do/autorm/meterQuery" method="post">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td width="286" colspan="2">
                  <peis:popedom type="SYS_OBJECT" styleId="sys_object" name="sys_object" mode="radio"/>
          ...
          <div id="cont_1">
            <div class="target">
              <ul>
                ...
                <li class="target_off" id="show6"><a href="#" onclick="changeShowType(6)"><bean:message bundle="autorm" key="autorm.dataquery.lable.xl"/></a></li>
                <li class="clear"></li>
              </ul>	
            </div>
