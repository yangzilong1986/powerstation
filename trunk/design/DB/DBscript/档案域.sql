...
create table C_GP  (
   ...
   GM_ID                NUMBER,
   GP_SN                NUMBER                         
      constraint CKC_GP_SN_C_GP check (GP_SN is null or ({\rtf1\ansi\ansicpg936\deff0\deflang1033\deflangfe2052{\fonttbl{\f0\fswiss\fprq2\fcharset0 MS Sans Serif;}}
\viewkind4\uc1\pard\lang2052\f0\fs17andandand\par
})),
   GP_CHAR              VARCHAR2(5),
   GP_TYPE              VARCHAR2(5),
