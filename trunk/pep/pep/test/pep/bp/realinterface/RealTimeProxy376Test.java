...
public class RealTimeProxy376Test {
    ...
    public void setProxy(RealTimeProxy376 proxy){
        this.proxy = proxy;
    }
...
//    @Test
  ...
  // @Test
    ...
    public void testTransmitMsg() throws Exception {    
        ...
        assertTrue(pack.getAddress().getAddress().equals("000000123456"));
