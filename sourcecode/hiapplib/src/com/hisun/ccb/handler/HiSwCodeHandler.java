   ...
   implements IHandler
 {
   ...
   private HiByteBuffer host2client(HiByteBuffer buf)
   {
     ...
     if (StringUtils.equalsIgnoreCase(this._code, "GBK"))
       len = HiGBSwCode.HostToClient(bs1, bs2);
     else if (StringUtils.equalsIgnoreCase(this._code, "BIG5"))
   ...
   private HiByteBuffer client2host(HiByteBuffer buf)
   {
     ...
     if (StringUtils.equalsIgnoreCase(this._code, "GBK"))
       len = HiGBSwCode.ClientToHost(bs1, bs2);
     else if (StringUtils.equalsIgnoreCase(this._code, "BIG5"))
