 ...
 public class HiExpMath
 {
     ...
     throws HiException
   {
     ...
     for (int i = 0; i < args.length; ++i) {
       if (StringUtils.equals(args[i], "1"))
         return "1";
     }
     return "0";
   }
   ...
   {
     if (args.length != 1)
       throw new HiException("215110", "NOT");
     ...
     throws HiException
   {
     ...
     for (int i = 0; i < args.length; ++i) {
       if (StringUtils.equals(args[i], "0"))
         return "0";
     }
     return "1";
   }
   ...
   {
     if (args.length < 2)
       throw new HiException("215110", "DIV");
     long result = NumberUtils.toLong(StringUtils.trim(args[0]));
     for (int i = 1; i < args.length; ++i) {
       result /= NumberUtils.toLong(StringUtils.trim(args[i]));
     }
   ...
   {
     if (args.length < 2)
       throw new HiException("215110", "MOD");
     long result = NumberUtils.toLong(StringUtils.trim(args[0]));
     for (int i = 1; i < args.length; ++i) {
       result %= NumberUtils.toLong(StringUtils.trim(args[i]));
     }
