...
public abstract class HiCnapsSplitedTag extends HiCnapsTagImpl implements HiCnapsSplitableTag {
    ...
    public HiCnapsTag getSubTagbyIndex(int index) {
        if (this.subTags.isEmpty()) return null;
    ...
    public void unpack2Etf(HiETF etf) throws HiException {
        ...
        if (!(StringUtils.isBlank(getSubTagRepeatName()))) etf.addNode(getSubTagRepeatName(), String.valueOf(subCnt));
    }
