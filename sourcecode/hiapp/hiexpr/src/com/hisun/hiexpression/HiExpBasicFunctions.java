...
public class HiExpBasicFunctions {
    ...
    public static String STRCAT(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "STRCAT");
    ...
    public static String STRNCAT(Object ctx, String[] args) throws HiException {
        if (args.length != 3) throw new HiException("215110", "STRNCAT");
        return args[0] + StringUtils.substring(args[1], 0, NumberUtils.toInt(StringUtils.trim(args[2])));
    }

    public static String STRCMP(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String SUBCMP(Object ctx, String[] args) throws HiException {
        if (args.length != 4) throw new HiException("215110", "SUBCMP");
    ...
    public static String LONGPOWER(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "LONGPOWER");
        long result = NumberUtils.toLong(StringUtils.trim(args[0]));
        for (int i = 1; i < args.length; ++i) {
            result = ()
            Math.pow(result, NumberUtils.toInt(StringUtils.trim(args[i])));
        }

        return String.valueOf(result);
    }

    public static String SHORTPOWER(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "SHORTPOWER");
        long result = NumberUtils.toLong(StringUtils.trim(args[0]));
        for (int i = 1; i < args.length; ++i) {
            result = ()
            Math.pow(result, NumberUtils.toInt(StringUtils.trim(args[i])));
    ...
    public static String INTCMP(Object ctx, String[] args) throws HiException {
        int i;
        if (args.length < 3) {
        ...
        switch (op) {
            case 1:
                for (i = 2; i < args.length; ++i) {
                    if (result >= NumberUtils.toLong(StringUtils.trim(args[i]))) return "0";
                }
                return "1";
            case 2:
                for (i = 2; i < args.length; ++i) {
    ...
    public static String DOUBLECMP(Object ctx, String[] args) throws HiException {
        int ret;
        int i;
        if (args.length < 3) {
    ...
    public static String IS_NOEQUAL_STRING(Object ctx, String[] args) throws HiException {
        if (args.length < 2) {
    ...
    public static String IS_EQUAL_INT(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String IS_EQUAL_DOUBLE(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String IS_EQUAL_STRING(Object ctx, String[] args) throws HiException {
        if (args.length < 2) {
    ...
    public static String ISNULL(Object ctx, String[] args) throws HiException {
        if (args.length == 0) {
            throw new HiException("215110", "ISNULL");
        }
        for (int i = 0; i < args.length; ++i) {
            if (!(StringUtils.isEmpty(args[i]))) return "0";
        }
        return "1";
    }

    public static String ISCHIN(Object ctx, String[] args) throws HiException {
        if (args.length == 0) {
    ...
    public static String STRLEN(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "STRLEN");
        return String.valueOf(args[0].getBytes().length);
    }

    public static String SUBSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
    ...
    public static String SUBRIGHT(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "SUBRIGHT");
    ...
    public static String ISNUMBER(Object ctx, String[] args) throws HiException {
        if (args.length == 0) {
            throw new HiException("215110", "ISNUMBER");
        }
        for (int i = 0; i < args.length; ++i) {
            if (!(StringUtils.isNumeric(args[i]))) return "0";
        }
        return "1";
    }

    public static String GETCHARPOS(Object ctx, String[] args) throws HiException {
        if (args.length != 3) throw new HiException("215110", "GETCHARPOS");
        ...
        for (int i = 0; (i < len) && (i < args[0].length()); ++i) {
            if (args[0].charAt(i) == args[2].charAt(0)) return String.valueOf(i);
        }
        return "-1";
    }

    public static String GETCHARPOSFROM(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
    ...
    public static String GETSTRPOS(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "GETSTRPOS");
    ...
    public static String DELSPACE(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
            throw new HiException("215110", "DELSPACE");
        }
        if (StringUtils.equalsIgnoreCase("left", args[1])) return StringUtils.stripStart(args[0], " ");
        if (StringUtils.equalsIgnoreCase("right", args[1])) return StringUtils.stripEnd(args[0], " ");
        if (StringUtils.equalsIgnoreCase("both", args[1])) return StringUtils.strip(args[0]);
    ...
    public static String DELBOTHSPACE(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String DELRIGHTSPACE(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String SPACE(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "SPACE");
    ...
    public static String INTTOSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "INTTOSTR");
        int length = NumberUtils.toInt(StringUtils.trim(args[1]));

        return StringUtils.leftPad(StringUtils.trim(args[0]), length, '0');
    }

    public static String ADDCHAR(Object ctx, String[] args) throws HiException {
        byte[] tmps;
        int i;
        if (args.length != 4) throw new HiException("215110", "ADDCHAR");
        if (isByteEnv()) ;
        int length = NumberUtils.toInt(StringUtils.trim(args[1]));
    ...
    public static String CUTDATALENGTH(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String TOUPPER(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String TOLOWER(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String REPSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
    ...
    public static String REPALLSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
    ...
    public static String DELCTRL(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
            throw new HiException("215110", "DELCTRL");
        }
        String str = args[0].trim();
        if (StringUtils.isEmpty(str)) throw new HiException("215111", "DELCTRL", "str");
    ...
    public static String REPCTRL(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String REVERSAL(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "REVERSAL");
        StringBuffer result = new StringBuffer();
    ...
    public static String LTRIM(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String RTRIM(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
            throw new HiException("215110", "LTRIM");
        }
    ...
    public static String TRIM(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
        ...
        if (StringUtils.equals(args[1].trim(), "both")) return StringUtils.trim(args[0]);
        if (StringUtils.equals(args[1].trim(), "right")) return StringUtils.stripEnd(args[0], "");
        if (StringUtils.equals(args[1].trim(), "left")) return StringUtils.stripStart(args[0], "");
        ...
        for (int i = 0; i < args[0].length(); ++i) {
            if (args[0].charAt(i) != args[1].charAt(0)) break;
        }
        for (int j = args[0].length() - 1; j > -1; --j) {
            if (args[0].charAt(j) != args[1].charAt(0)) break;
        }
        return args[0].substring(i, j + 1);
    }

    public static String NullToEmpty(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String INSERTCHAR(Object ctx, String[] args) throws HiException {
        if (args.length < 2) {
    ...
    public static String GETWORDDELIMITER(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
        ...
        if (seq > temp.length) return "";
        return temp[(seq - 1)];
    }

    public static String LEFTSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "LEFTSTR");
        return StringUtils.left(args[0].trim(), NumberUtils.toInt(StringUtils.trim(args[1])));
    }

    public static String RIGHTSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "RIGHTSTR");
        return StringUtils.right(args[0], NumberUtils.toInt(StringUtils.trim(args[1])));
    }

    public static String STRGETCOUNT(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String FABSAMT(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String ISLEAPYEAR(Object ctx, String[] args) throws HiException {
        return ISLEAPYEAR(args);
    }

    public static String ISLEAPYEAR(String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "ISLEAPYEAR");
    ...
    public static String FMTDATE(Object ctx, String[] args) throws HiException {
        if (args.length != 3) throw new HiException("215110", "FMTDATE");
        String str = args[0].trim();
    ...
    public static String FMTSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) throw new HiException("215110", "FMTSTR");
    ...
    public static String CHECKDATE(Object ctx, String[] args) throws HiException {
    ...
    public static String GETDATETIME(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String GETDATETIME(Object ctx) throws HiException {
        return GETDATETIME(ctx, new String[]{"yyyyMMDDHHmmss"});
    }

    public static String GETDATE(Object ctx) throws HiException {
    ...
    public static String GETSECOND(Object ctx, String[] args) throws HiException {
        long curSec;
    ...
    public static String CALCTIME(Object ctx, String[] args) throws HiException {
        if (args.length < 4) throw new HiException("215110", "CALCTIME");
        ...
        try {
            ...
            num *= sign;
            if (args[2].equals("y")) dt = DateUtils.addYears(dt, num);
            else if (args[2].equals("M")) dt = DateUtils.addMonths(dt, num);
            else if (args[2].equals("d")) dt = DateUtils.addDays(dt, num);
            else if (args[2].equals("h")) dt = DateUtils.addHours(dt, num);
            else if (args[2].equals("m")) dt = DateUtils.addMinutes(dt, num);
            else if (args[2].equals("s")) dt = DateUtils.addSeconds(dt, num);
            else {
    ...
    public static String CALCDATE(Object ctx, String[] args) throws HiException {
        ...
        if ((StringUtils.isEmpty(str)) || (str.length() != 8)) throw new HiException("215111", "CALCDATE", "str");
        try {
            ...
            if (obj.equals("y")) {
                if (op.equals("+")) iYear += iNum;
                else if (op.equals("-")) {
                    iYear -= iNum;
                }
                if (iMonth == 2) if (ISMONTHEND(new String[]{str}).equals("1"))
                    if (ISLEAPYEAR(new String[]{Integer.toString(iYear)}).equals("0")) {
                        iDay = 29;
                    } else iDay = 28;
            } else {
                if (obj.equals("m")) {
                    if (op.equals("+")) iMonth += iNum;
                    else if (op.equals("-")) {
                        iMonth -= iNum;
                    }
    ...
    public static String ISYEAREND(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
            throw new HiException("215110", "ISYEAREND");
        }
        String str = args[0].trim();
        if (!(StringUtils.isEmpty(str))) if (CHECKDATE(new String[]{str}).equals("0")) break label54;
        return "0";
        try {
            label54:
            String[] pt = {"yyyyMMdd"};
    ...
    public static String ISQUARTEREND(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
        ...
        try {
            ...
            int iMonth = calendar.get(2) + 1;
            int iDay = calendar.get(5);
            if ((iMonth == 3) && (iDay == 31)) return "1";
            if ((iMonth == 6) && (iDay == 30)) return "1";
            if ((iMonth == 9) && (iDay == 30)) return "1";
            if ((iMonth == 12) && (iDay == 31)) {
                return "1";
            }
            return "0";
    ...
    public static String ISMONTHEND(Object ctx, String[] args) throws HiException {
    ...
    public static String ISMONTHEND(String[] args) throws HiException {
        ...
        String str = args[0].trim();
        if ((StringUtils.isEmpty(str)) || (!(CHECKDATE(args).equals("0")))) return "0";
        str = str.trim();
        try {
            String[] pt = {"yyyyMMdd"};
            Date dt = DateUtils.parseDate(str, pt);
    ...
    public static String ISWEEKEND(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String DIFFDATE(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
        ...
        if (CHECKDATE(new String[]{date1}).equals("0")) if (CHECKDATE(new String[]{date2}).equals("0")) break label112;
        throw new HiException("215111", "DIFFDATE", "date1|date2");
    ...
    public static String CALCMONTH(Object ctx, String[] args) throws HiException {
        int diff = 0;
        ...
        String date2 = args[1].trim();
        String flag = null;
        if (args.length == 3) flag = args[2].trim();
        else {
            flag = "0";
        }
        ...
        if (CHECKDATE(new String[]{date1}).equals("0")) if (CHECKDATE(new String[]{date2}).equals("0")) break label159;
        throw new HiException("215111", "CALCMONTH", "date1|date2");
        try {
            label159:
            String[] pt = {"yyyyMMdd"};
            ...
            if ("0".equals(flag.trim())) {
                ...
                diff = Math.abs(iYear2 - iYear1);
                if (dt2.getTime() >= dt1.getTime()) diff = diff * 12 + iMonth2 - iMonth1;
                else diff = diff * 12 + iMonth1 - iMonth2;
            } else {
    ...
    public static String CALCYEAR(Object ctx, String[] args) throws HiException {
        int diff = 0;
    ...
    public static String NORMAL_TO_COBOL(Object ctx, String[] args) throws HiException {
        int i;
        String ret = "";
        if (args.length != 2) {
    ...
    public static String COBOL_TO_NORMAL(Object ctx, String[] args) throws HiException {
        int flag = 1;
        int iLen = 0;
        String ret = "";
    ...
    public static String NORMAL_TO_EBCD(Object ctx, String[] args) throws HiException {
        int flag = 1;
        int iLen = 0;
        String ret = "";
        ...
        if (flag == -1) {
            if (buf[(buf.length - 1)] == '0') buf[(buf.length - 1)] = '}';
            else {
                buf[(buf.length - 1)] = (char) (buf[(buf.length - 1)] - '1' + 74);
            }

        } else if (buf[(buf.length - 1)] == '0') buf[(buf.length - 1)] = '{';
        else {
    ...
    public static String AMTADDDOT(Object ctx, String[] args) throws HiException {
    ...
    public static String AMTADDDOT(String[] args) throws HiException {
        ...
        if (buf.length() >= 3) buf.insert(buf.length() - 2, '.');
        else if (buf.length() == 2) buf.insert(0, "0.");
        else if (buf.length() == 1) buf.insert(0, "0.0");
    ...
    public static String AMTTOCAP(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
            ...
            if (flag == 0) {
                ...
                if ((len - i != 3) && (len - i != 7) && (len - i != 11) && (len - i != 15)) {
                    if ((i < len - 1) && (Amount[(i + 1)] != '0') && (i <= endzero)) {
                        ...
                        if ((i != len - 2) || (Amount[(len - 1)] == '0')) continue;
                        ChAmount.append("零");
                        count_zero = 0;
                    }
    ...
    public static String AMTDELZERO(Object ctx, String[] args) throws HiException {
    ...
    public static String AMTFMT(Object ctx, String[] args) throws HiException {
        int j;
        if (args.length != 1) {
    ...
    public static String AMTSIMPLEFMT(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String CYCAMTFALSE(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
        ...
        if ((((StringUtils.equals(cyccod, "ITL")) || (StringUtils.equals(cyccod, "JPY")))) && (len != 0)) {
            ret = "1";
        }
    ...
    public static String CSUBSTR(Object ctx, String[] args) throws HiException {
        if (args.length != 3) {
    ...
    public static String AMTPOWER(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String GETENV(Object ctx, String[] args) throws HiException {
        return GETENV(args);
    }

    public static String GETENV(String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "GETENV");
        try {
    ...
    public static String ADDAMT(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "ADDAMT");
        int value = 0;
        for (int i = 0; i < args.length; ++i) {
    ...
    public static String DELCHAR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String DELBOTHCHAR(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String SUBAMT(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String HEX2STR(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "HEX2STR");
        try {
    ...
    public static String STR2HEX(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "HEX2STR");
        return new String(Hex.encodeHex(args[0].getBytes()));
    }

    public static String REPCHAR(Object ctx, String[] args) throws HiException {
        if (args.length != 3) throw new HiException("215110", "REPCHAR");
        return StringUtils.replace(args[0], args[1], args[2]);
    }

    public static String EBCD_TO_NORMAL(Object ctx, String[] args) throws HiException {
        if (args.length != 2) {
    ...
    public static String BIN2HEX(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "BIN2HEX");
        try {
    ...
    public static String HEX2BIN(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "HEX2BIN");
        String binStr = "";
        try {
    ...
    public static String FADD(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String FSUB(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String FMUL(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String FDIV(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String FPOW(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String DATETOCAP(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
    ...
    public static String GETFILELINES(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
        ...
        if (!(filepath.isAbsolute())) {
            ...
            if (root != null) {
                if (root.endsWith("/")) root = root + file;
                else {
                    root = root + file + "/";
                }
                file = root;
    ...
    public static String GETFILESIZE(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
        ...
        if (!(filepath.isAbsolute())) {
            String[] homeArgs = {"HWORKDIR"};
            String root = GETENV(homeArgs);
            if (root != null) filepath = new File(root, file);
            else {
    ...
    public static String TODBC(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "TODBC");
        if (args[0] == null) {
            return null;
        }
    ...
    public static String TOSBC(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "TOSBC");
        if (args[0] == null) {
            return null;
        }
    ...
    public static String CHAOSCODE(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "CHAOSCODE");
        if (args[0] == null) {
            return null;
        }
        String str = args[0];
    ...
    public static String CHNCONVERT(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
    ...
    public static String IS_MATCH(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "IS_MATCH");
        ...
        if (ignoreCase) p = Pattern.compile(args[1]);
        else {
    ...
    public static String CONDITION3(Object ctx, String[] args) throws HiException {
        if (args.length < 3) {
    ...
    public static String IsExistNode(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
    ...
    public static String RANDOM(Object ctx, String[] args) throws HiException {
        if (args.length < 2) {
        ...
        if (StringUtils.equals(args[1], "0")) return RandomStringUtils.randomAlphanumeric(len);
    ...
    public static String ETF(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "ETF");
        return ((HiMessageContext) ctx).getCurrentMsg().getETFBody().getGrandChildValue(args[0]);
    }

    public static String BLANK(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "BLANK");
        int len = NumberUtils.toInt(args[0]);
        return StringUtils.leftPad("", len);
    }

    public static String DATEPROC(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "DATEPROC");
        return args[0].replaceAll("-", "");
    }

    public static String AMTPROC(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "AMTPROC");
        return args[0].replaceAll("[,.]", "");
    }

    public static String DECODE(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "ENCODE");
        try {
    ...
    public static String ENCODE(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "ENCODE");
        try {
    ...
    public static String XOREncrypt(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String XORDecrypt(Object ctx, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String HEX2DEC(Object object, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String DEC2HEX(Object object, String[] args) throws HiException {
        if (args.length != 1) {
    ...
    public static String ISALPHANUMERIC(Object object, String[] args) throws HiException {
        if (args.length == 0) {
    ...
    public static String FORMATTIME(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "FORMATTIME");
    ...
    public static String ISFILE(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "ISFILE");
        for (int i = 0; i < args.length; ++i) {
            File f = null;
    ...
    public static String ISDIR(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "ISDIR");
        for (int i = 0; i < args.length; ++i) {
            File f = null;
            if (!(args[i].startsWith(SystemUtils.FILE_SEPARATOR)))
                f = new File(HiICSProperty.getWorkDir() + "/" + args[i]);
    ...
    public static String ISJAR(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "ISJAR");
        for (int i = 0; i < args.length; ++i) {
            String name = args[i];
            if (!(name.startsWith(SystemUtils.FILE_SEPARATOR))) name = HiICSProperty.getWorkDir() + "/" + name;
            try {
    ...
    public static String SaveToTDS(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "SaveToTDS");
    ...
    public static String DeleteTDS(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
    ...
    public static String LoadFromTDS(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
            throw new HiException("215110", "LoadFromTDS");
        }
        if (!(memoryTD.containsKey(args[0]))) {
    ...
    public static String GetETFValue(Object ctx, String[] args) throws HiException {
        if (args.length < 1) {
    ...
    public static String SetETFValue(Object ctx, String[] args) throws HiException {
        if (args.length < 2) {
    ...
    public static String GetETFName(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "getETFName");
        HiMessageContext msgCtx = (HiMessageContext) ctx;
        HiMessage msg = msgCtx.getCurrentMsg();
        HiETF root = msg.getETFBody();
        HiETF node = root.getGrandChildNode(args[0]);
    ...
    public static String SetETFName(Object ctx, String[] args) throws HiException {
        if (args.length < 2) throw new HiException("215110", "setETFName");
        HiMessageContext msgCtx = (HiMessageContext) ctx;
        HiMessage msg = msgCtx.getCurrentMsg();
        HiETF root = msg.getETFBody();
        HiETF node = root.getGrandChildNode(args[0]);
    ...
    public static String HZ2PY(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "HZ2PY");
        return args[0];
    }

    public static String UCOMP3(Object ctx, String[] args) throws HiException {
        if (args.length < 3) throw new HiException("215110", "UCOMP3");
        return args[0];
    }

    public static String COMP3(Object ctx, String[] args) throws HiException {
        if (args.length < 3) throw new HiException("215110", "COMP3");
        return args[0];
    }
    ...
    public static String Encrypt(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "XOREncrypt");
        return args[0];
    }

    public static String Decrypt(Object ctx, String[] args) throws HiException {
        if (args.length != 1) throw new HiException("215110", "XOREncrypt");
        return args[0];
    }

    public static String PAD(Object ctx, String[] args) throws HiException {
        if (args.length < 3) throw new HiException("215110", "PAD");
        if ("0".equals(args[1])) {
            if (args.length < 4) {
    ...
    public static String CHAR(Object ctx, String[] args) throws HiException {
        if (args.length < 1) throw new HiException("215110", "CHAR");
