...
public class HiMultiService {
    public static Collection<HiETF> query(HiMultiDTO md) throws HiException {
    ...
    public static int getTotalPage(HiMultiDTO md) throws HiException {
        return md.getMultiQuery().getTotalPage();
    }

    public static int getCurrPageRecCounts(HiMultiDTO md) throws HiException {
        Collection result_Strs = md.getMultiQuery().process();
        return ((result_Strs != null) ? result_Strs.size() : 0);
    }

    public static int getTotalRec(HiMultiDTO md) throws HiException {
