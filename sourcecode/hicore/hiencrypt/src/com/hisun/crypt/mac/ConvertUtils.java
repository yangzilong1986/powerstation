 ...
 public abstract class ConvertUtils
 {
   ...
   public static final int objectToInt(Object o) {
     ...
     try {
       ...
       return Integer.parseInt(o.toString()); } catch (NumberFormatException e) {
     }
     return -1;
   }
   ...
   public static final short objectToShort(Object o)
   {
     ...
     try {
       ...
       return Short.parseShort(o.toString()); } catch (NumberFormatException e) {
     }
     return -1;
   }
   ...
   public static final double objectToDouble(Object o)
   {
     ...
     try {
       ...
       return Double.parseDouble(o.toString()); } catch (NumberFormatException e) {
     }
     return -1.0D;
   }
   ...
   public static final long objectToLong(Object o)
   {
     ...
     try {
       ...
       return Long.parseLong(o.toString()); } catch (NumberFormatException e) {
     }
     return -1L;
   }
   ...
   public static final Object getObjectValue(String value)
   {
     try {
       ...
       try {
         return Double.valueOf(value); } catch (NumberFormatException e) { }
     }
     return value;
   }
   ...
   {
     return ((t != null) ? new java.util.Date(Math.round(t.getTime() + t.getNanos() / 1000000.0D)) : null);
   }
   ...
   {
     double base = Math.pow(10.0D, roundingPoint);
