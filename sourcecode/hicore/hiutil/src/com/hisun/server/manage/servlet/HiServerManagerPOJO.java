 ...
 public class HiServerManagerPOJO
 {
     ...
     throws Exception
   {
     ...
     if (_log.isDebugEnabled()) {
       _log.debug(String.format("invoke:[%s][%s][%s]", new Object[] { args[0], args[1], args[2] }));
     }
   ...
   {
     if (_log.isDebugEnabled()) {
       _log.debug(String.format("invoke server:[%s][%s]", new Object[] { mode, server.getName() }));
     }
