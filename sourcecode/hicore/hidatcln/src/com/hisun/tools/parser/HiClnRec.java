 ...
 public class HiClnRec
 {
   ...
   public void setDatefmt(String datefmt) {
     if (StringUtils.equals("YYYYMMDD", datefmt))
       this._datefmt = "yyyyMMdd";
     else
   ...
   public void processNormal(HiClnParam param) throws Exception
   {
     ...
     {
       if (this._dateType == 0)
         date = DateUtils.parseDate(param._sysDate, new String[] { this._datefmt });
       else if (this._dateType == 1)
         date = new Date();
       else {
         date = new Date();
       }
