...
public class HiFileTag extends BodyTagSupport {
    ...
    public void setFile(String file) throws JspException {
        ...
        if ((file == null) || (file.equals(""))) throw new JspException("file property is empty");
    ...
    public void setSeparator(String separator) throws JspException {
        ...
        if (StringUtils.isEmpty(this.separator)) throw new JspException("separator property is empty");
    ...
    public void setGroupName(String groupName) throws JspException {
        ...
        if (StringUtils.isEmpty(this.groupName)) throw new JspException("groupName property is empty");
    ...
    public void setCharSet(String charSet) throws JspException {
        ...
        if (StringUtils.isEmpty(this.charSet)) throw new JspException("charSet property is empty");
    ...
    public void setTailLines(String tailLines) throws Exception {
    ...
    public static void accumulate(JSONObject obj, String str) {
        ...
        if (obj.containsKey("separator")) {
            ...
            for (j = 0; j < array.size(); ++j) {
                ...
                if (j >= tmps.length) obj.accumulate("value", "");

                else obj.accumulate("value", tmps[j]);
            ...
            for (j = 0; j < array.size(); ++j) {
                ...
                if (offset + obj.getInt("length") >= str.length()) obj.accumulate("value", "");
    ...
    public static HashMap accumulate2HashMap(JSONObject obj, String str) {
        ...
        for (int i = 0; i < array.size(); ++i) {
            ...
            if (tmpObj.containsKey("value")) map.put(tmpObj.get("name"), tmpObj.get("value"));
