...
public class HiRawServiceImpl extends HiAbstractChannelService implements IChannelService {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (this._log.isInfoEnabled()) this._log.info("service: [" + service + "]");
        ...
        if (!(this._serverName.equalsIgnoreCase(service))) msg.setHeadItem("STC", service);
        ...
        if (StringUtils.isNotBlank(this._encoding)) response.setCharacterEncoding(this._encoding);
