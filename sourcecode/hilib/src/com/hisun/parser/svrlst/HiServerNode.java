...
public class HiServerNode {
    ...
    public String getStatusMsg() {
        ...
        if (this.status == 0) return "停止";

        if (this.status == 1) return "启动";

        if (this.status == 2) return "暂停";

        if (this.status == 3) return "失败";
    ...
    public String toHTML() {
        ...
        if (this.status == 0) buffer.append("<td bgcolor = 'yellow' width='10%'> ");

        else if (this.status == 1) buffer.append("<td  bgcolor = 'green' width='10%'> ");

        else if (this.status == 3) buffer.append("<td  bgcolor = 'red' width='10%'> ");

        else if (this.status == 4) buffer.append("<td  bgcolor = 'white' width='10%'> ");
