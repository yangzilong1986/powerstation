...
public final class HiStringUtilExt {
    ...
    public static String numeroToString(int numero, int decimais, int tamanho, String separadorDecimal, String separadorMilhares, boolean truncar) {
        ...
        if (truncar) num = Math.round(Math.floor(numero));
        ...
        do {
            ...
            while ((num >= 1000L) && (auxMilhar.length() < tamMilhar)) {
    ...
    public static String rTrim(String str) {
        ...
        while ((tam > 0) && (Character.isWhitespace(result.charAt(tam - 1)))) {
            ...
            if (c != '%') {
                ...
                switch (type) {
                    ...
                    case 'c':
                        ...
                        if (obj instanceof Character) caractere = ((Character) obj).charValue();
