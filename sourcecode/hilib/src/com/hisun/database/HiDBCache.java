...
public class HiDBCache {
    ...
    public static List execQuery(String strSql, int limits, HiJDBCProvider dbutil) throws HiException {
    ...
    public static int execUpdate(String strSql, HiJDBCProvider dbutil) throws HiException {
    ...
    public static HiResultSet execQuerySQL(String strSql, HiJDBCProvider dbutil) throws HiException {
