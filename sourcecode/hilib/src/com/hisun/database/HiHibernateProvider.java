...
public abstract class HiHibernateProvider extends HiJDBCProvider implements DataAccessProvider {
    ...
    public Connection getConnection() throws HiException {
        ...
        if (this._connection == null) getSession();
    ...
    public List list(Class clazz, String sql, Object[] params) throws HiException {
        ...
        try {
            ...
            if (sql != null) query = getSession().createSQLQuery(sql).addEntity(clazz);
