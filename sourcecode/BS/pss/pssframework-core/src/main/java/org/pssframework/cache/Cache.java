...
public abstract class Cache {
	...
	static void checkSerializable(Object value) {
		if (!(value instanceof Serializable))
			throw new IllegalStateException("Cannot cache a non-serializable value of type "
					+ value.getClass().getName(), new NotSerializableException(value.getClass().getName()));
	}
