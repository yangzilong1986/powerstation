...
/**
 * 1) 描述变压器的运行信息及铭牌参数，包括变压器编码、变压器型号、变压器铭牌容量、当前状态等信息 2) 通过线损基础信息管理业务中录入产生，或新装增容与变更用电归档过程产生；或通过与生产系统接口过程产生。 3)
...
public class TranInfo extends BaseEntity {
	...
	/**
	 * @param frstsideVoltCode
	 *            the frstsideVoltCode to set
	 */
	...
	/**
	 * @param sndsideVoltCode
	 *            the sndsideVoltCode to set
	 */
