    ...
    if(logicAddr==null){
       alert("请选择终端");
	    ...
	    if(top.getMainFrameObj()!=null){
          ...
          if(top.getMainFrameObj().lowCustTermFlag == 1){
            top.getMainFrameObj().loadGmSelect();
          }
        }
        ...
        if(top.getMainFrameObj().mainframe!=null){
           top.getMainFrameObj().mainframe.$('#termId').append("<option value='"+termId+"' selected>"+logicAddr+"</option>");
        }
	    parent.GB_hide();
    }
}
...
<div id="main">
  <html:form  action="/archive/termListQuery" method="post">
  <input type="hidden" name="action" value="normalMode">
  <input type="hidden" name="sqlCode" value="AL_ARCHIVE_0022">
