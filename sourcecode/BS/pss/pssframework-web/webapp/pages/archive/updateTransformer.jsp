    ...
    <div class="main">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="900" align="center">
        ...
        <tr>
          ...
          <td width="20%" class="dom"><input type="text" id="tgCapa" name="tranCapa" value="<fmt:formatNumber value="${object_tran.tranCapa}" pattern=".000"  minFractionDigits="0"/>"  style="width: 115px;"/> kVA</td>
