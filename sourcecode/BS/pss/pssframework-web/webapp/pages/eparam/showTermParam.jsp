            ...
            "commandItems": [
                    {
                            "identifier": "10040001", 
                            "datacellParam": [ 
                                    {"dataItemCode": "1004000101", "dataItemValue": "5"},
                    ...
                    },
                    {
                            "identifier": "10040003", 
                            "datacellParam": [ 
                                    {"dataItemCode": "1004000301", "dataItemValue": "192.168.1.100:1024"},
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <thead>
                  <tr>
                    ...
                    <th width="30%" class="bg01">数据名称</th>
                ...
                <tbody class="tblcontent2">
                  ...
                  <!-- 10040001 终端上行通信口通信参数设置 -->
                    <tr class="clz10040001" style="display: none;">
                      <td height="25">&nbsp;</td>
                      <td colspan="2" align="right">终端数传机延时时间RTS</td>
                      <td>
                        <select id="1004000101" name="1004000101">
                    ...
                    <tr class="clz10040001" style="display: none;">
                      ...
                      <td><input id="1004000102" name="1004000102" value="1" /></td>
                      <td>&nbsp;</td>
                      <td>min</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr class="clz10040001" style="display: none;">
                      ...
                      <td><input id="1004000103" name="1004000103" value="10" /></td>
                      <td>&nbsp;</td>
                      <td>秒</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr class="clz10040001" style="display: none;">
                      ...
                      <td><input id="1004000104" name="1004000104" value="5" /></td>
                      <td>&nbsp;</td>
                      <td>次</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr class="clz10040001" style="display: none;">
                      ...
                      <td><input id="1004000106" name="1004000106" value="00100000" /></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr class="clz10040001" style="display: none;">
                      ...
                      <td><input id="1004000107" name="1004000107" value="30" /></td>
                      <td>&nbsp;</td>
                      <td>min</td>
                      <td>&nbsp;</td>
                    </tr>
                  ...
                  <!-- 10040003 主站IP地址和端口 -->
                    <tr class="clz10040003" style="display: none;">
                      <td height="25">&nbsp;</td>
                      <td colspan="2" align="right">主用IP地址和端口</td>
                      <td>192.168.1.100:1024</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                  ...
                  <!-- 10040004 主站电话号码和短信中心号码 -->
                    <tr class="clz10040004" style="display: none;">
                      <td height="25">&nbsp;</td>
                  ...
                  <!-- 10040008 终端上行通信工作方式（以太专网或虚拟专网） -->
                    <tr class="clz10040008" style="display: none;">
                      <td height="25">&nbsp;</td>
                  ...
                  <!-- 10040009 终端上行通信工作方式（以太专网或虚拟专网） -->
                    <tr class="clz10040009" style="display: none;">
                      <td height="25">&nbsp;</td>
