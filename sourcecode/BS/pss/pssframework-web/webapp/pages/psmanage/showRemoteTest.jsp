  ...
  <ul class=default id=electric_Con_1>
    ...
    <div id="bg" style="height: 30px; text-align: center;">
      <ul id=”datamenu_Option“ class="cb font1">
        <li class="curr" id=datamenu_Option_0 style="cursor: pointer;">远程试验跳</li>
      </ul>
    </div>
              ...
              <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="180" height="100%">
                    <iframe id="psTreeFrame" name="psTreeFrame" src="<pss:path type="webapp"/>/pages/psmanage/psTree.jsp?type=rmttest" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>
                  </td>
                  <td width="3" height="100%" style="background-color: #bbdcd8;"></td>
                  <td>
                    <iframe id="psRemoteTestFrame" name="psRemoteTestFrame" src="<pss:path type="webapp"/>/pages/psmanage/psRemoteTest.jsp" scrolling="auto" width="100%" height="100%" frameborder="0"></iframe>
                  </td>
                </tr>
              </table>
            </div>
