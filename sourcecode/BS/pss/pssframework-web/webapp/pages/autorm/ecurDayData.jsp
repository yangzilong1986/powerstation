...
<html>
  ...
  <body>
    <form name="form1" action="<peis:contextPath/>/singleUserQuery.do?action=queryEcurDayData" method="post" onsubmit="return checkForm();">
               ...
               <td height="335" width="40%">
                  <div id="tableContainer" class="tableContainer" style="width:350px;height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 120));">
                    ...
                    <thead><tr>
                       ...
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.axdl"/></th>
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.bxdl"/></th>
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.cxdl"/></th>
                       <th><bean:message bundle="autorm" key="autorm.dataquery.lable.dl0x"/></th>
                    </tr>
                    </thead>
                    <tbody>
