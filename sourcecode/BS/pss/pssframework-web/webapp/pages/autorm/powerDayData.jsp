...
<html>
  ...
  <body>
    <form name="form1" action="<peis:contextPath/>/singleUserQuery.do?action=queryPowerDayData" method="post" onsubmit="return checkForm();">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="function_title">
		<tr>
		  <td>
             ...
             <bean:message bundle="autorm" key="autorm.dataquery.lable.jld"/>：<peis:selectlist sql="QUERY0007" name="gp_id" extendProperty=""/>
      ...
      <table width="100%" border=0 cellpadding=0 cellspacing=0 align="center">
            <tr>
               <td width="60%"><%=request.getAttribute("CHART_CODE")==null?"":request.getAttribute("CHART_CODE")%></td>
               <td width="40%">
                  <div id="tableContainer" class="tableContainer" style="height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 140));">
                    ...
                    <thead><tr>
                       ...
                       <logic:equal value="1" name="showType">
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.yggl"/></th>
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.wggl"/></th>
                       </logic:equal>
                       <logic:equal value="2" name="showType">
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.axyggl"/></th>
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.axwggl"/></th>
                       </logic:equal>
                       <logic:equal value="3" name="showType">
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.bxyggl"/></th>
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.bxwggl"/></th>
                       </logic:equal>
                       <logic:equal value="4" name="showType">
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.cxyggl"/></th>
                          <th><bean:message bundle="autorm" key="autorm.dataquery.lable.cxwggl"/></th>
                       </logic:equal>
                    </tr>
                    </thead>
                    <tbody>
