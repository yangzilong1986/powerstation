            ...
            jQuery.ajax({
                ...
                success:function(json){
                    ...
                    if(msg=="1"){
                       alert("保存成功");
                       parent.GB_hide();
                       top.getMainFrameObj().location.href=contextPath+"/archive/lowCustListQuery.do?action=normalMode&sqlCode=AL_ARCHIVE_0024&pageRows=20";
                    }else if(msg=="2"){
                       alert("该用户已经存在");
                    }else if(msg=="3"){
                       alert("表号已经存在");
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
             ...
             <tr>
              ...
              <td width="23%" class="dom" id="portDom">
                <input type="text" id="port" name="port" value="${object_gp.port!="" ? object_gp.port : "001"}"/>
              </td>
