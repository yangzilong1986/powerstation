                ...
                success:function(msg){
                    ...
                    if(msg=="1"){
                       ...
                       if(confirm("是否继续新增用户")==true){
                           window.location.href=contextPath+"/archive/addLowCustInfoAction.do?action=finishSecond";
                       }else{
  ...
  <div id="main">
    ...
    <div class="tab_con" style="height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 123));">
      <div class="main">
        ...
        <input type="hidden" name="sar"/>
        <input type="hidden" name="custId"/>
        <input type="hidden" name="termProNo" id="termProNo"/>
        <!-- 中继地址 -->
        <input type="hidden" name="relayAddr1" id="relayAddr1"/>
        <input type="hidden" name="relayAddr2" id="relayAddr2"/>
        <input type="hidden" name="relayAddr3" id="relayAddr3"/>
        <input type="hidden" name="relayAddr4" id="relayAddr4"/>
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td width="10%" class="label"><font color="red">* </font>户　号：</td>
            <td width="17%" class="dom"><input type="text" id="custNo" name="custNo" value="" /></td>
            <td width="10%" class="label"><font color="red">* </font>户　名：</td>
            <td width="17%" class="dom"><input type="text" id="custName" name="custName" value="" /></td>
          ...
          <tr>
            ...
            <td width="17%" class="dom">
               <input type="text" name="rmDay" id="rmDay">
            </td>
            <td width="10%" class="label">抄表区号：</td>
            <td width="17%" class="dom">
                <input type="text" name="rmSectNo" id="rmSectNo">
            </td>
            <td width="10%" class="label">抄表顺序号：</td>
            <td width="17%" class="dom">
                <input type="text" name="rmSn" id="rmSn">
            </td>
            <td width="10%" class="label">表 箱 号：</td>
            <td width="17%" class="dom">
                <input type="text" name="meterBox" id="meterBox">
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3" class="dom">
                <input type="text" name="custAddr" id="custAddr" style="width: 373px;"/>
            </td>
          </tr>
          <tr>
            <td class="label">备　注：</td>
            <td colspan="5" class="dom">
                <textarea class="input_textarea3" name="remark" style="width: 370px;"></textarea>
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="data3_con">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
             <tr>
              ...
              <td width="23%" class="dom">
               <input type="text" id="gpSn" name="gpSn" value="" />
              </td>
             </tr>
             <tr>
              <td width="10%" class="label">
              ...
              <td width="23%" class="dom">
               <input type="text" id="gpAddr" name="gpAddr" value="" />
              </td>
              <td width="10%" class="label">
               CT变比：
              </td>
             ...
             <tr>
              ...
              <td width="23%" class="dom"><peis:selectlist name="protocolNo" sql="SL_ARCHIVE_0022"/>
              </td>
              <td width="10%" class="label">
               通讯方式：
              </td>
             ...
             <tr>
              ...
              <td width="23%" class="dom">
               <input type="text" id="meterDigits" name="meterDigits" value="6" />
              </td>
              <td width="10%" class="label">
               是否预付费：
              </td>
              ...
              <td width="23%" class="dom_date">
               <input type="text" name="mpDate" id="mpDate" value="2009-01-01" onfocus="peisDatePicker()" readonly="readonly" />
              </td>
             </tr>
             <tr>
              ...
              <td width="23%" class="dom" id="commPwdDom">
                <input type="password" id="commPwd" name="commPwd" value=""/>
              </td>
