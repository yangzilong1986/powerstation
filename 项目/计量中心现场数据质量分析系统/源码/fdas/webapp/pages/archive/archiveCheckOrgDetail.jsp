...
<form name="archiveCheckForm" action="114002.dow" method="post" id="mainform">
          ...
          <tbody id="tbody">
             <c:forEach items="${ETF.REC}" var="OBJECT" varStatus="status">
                <tr onClick="selectSingleRow(this);" style="cursor:pointer;" align="left">
                 ...
                 <td align="center">${OBJECT.POWERSUPPLYOFFICENAME}</td> 
...
<script type="text/javascript">
 ...
 var all_page='${ETF.PAG_CNT}';
    ...
    var first_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvFirst('114002.dow','WantedPerPage')\"><img style='margin-left:-5;margin-right:7;' src=\"<peis:contextPath/>/img/page_home.gif\" class=\"pointer\"/></a>\n";
    var forward_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvForward('114002.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_prew.gif\" class=\"pointer\"/></a>\n";
    var next_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvNext('114002.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_next.gif\" class=\"pointer\"/></a>\n";
    var end_able_Style="<a href=\"#\" id=\"queryNext\" onclick=\"pagemvEnd('114002.dow','WantedPerPage')\"><img style='margin-left:7;margin-right:7;' src=\"<peis:contextPath/>/img/page_end.gif\" class=\"pointer\"/></a>\n";
    ...
    function getTargetPage(){
        ...
        var targetURL = "114002.dow?PAG_NO="+page+"&"+$("#mainform").serialize();
