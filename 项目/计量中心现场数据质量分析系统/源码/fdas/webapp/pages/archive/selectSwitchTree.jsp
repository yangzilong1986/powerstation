          ...
          <ul>
              <c:forEach items="${ETF.TERMINAL}" var="MSG">
              	<li class="closed" id="${MSG.TERM_ID}">
              		<table style="display:inline;margin-left:-2pt;margin-top:-3pt;" ><tr>
              			<td><img src="../../img/tree/object_org.gif" alt="" width="15" height="15" align="bottom"></td>
...
function queryMeterMp(FLG,SUBS_ID,liid){
         ...
         success:function(data){
         	       ...
         	       if(allMsg!=undefined){
         	         ...
         	         for (var i = 0 ; i < datalength ; i++){
         	             ...
         	             datahtmlall +="<td><img src='../../img/tree/object_org.gif' alt='' width='15' height='15' align='bottom'></td>";
    ...
    if(objectI=="SUBS"){
      window.parent.mainframe.location.href="112024.dow?SUBS_ID="+tempSUBS_ID+"&FLG=QUERY&OPEN_NEW=switchStation.jsp";
    }
    if(objectI=="TERM"){
      window.parent.mainframe.location.href="112035.dow?TERM_ID="+objectId+"&SUBS_ID="+subsId+"&FLG=QUERY&SUBS_TYPE=3";
    }
    if(objectI=="TRAN"){
      window.parent.mainframe.location.href="112030.dow?TRAN_ID="+objectId+"&SUBS_ID="+subsId+"&FLG=QUERY&SUBS_TYPE=3";
    }
    if(objectI=="ML"){
  	  window.parent.mainframe.location.href="112031.dow?ML_ID="+objectId+"&SUBS_ID="+subsId+"&FLG=QUERY&SUBS_TYPE=3";
    }
     if(objectI=="MP"){
