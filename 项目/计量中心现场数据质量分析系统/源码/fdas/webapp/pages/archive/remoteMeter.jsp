...
function meterState(){
   ...
   if(mpId == ''){ //新增电表
       if(meterState=="1"){
	      ...
	      var url="<peis:contextPath/>/jsp/archive/addMeterInfo.jsp";
	   } 
  ...
  <div class="tab_con" style="height:expression(((document.documentElement.clientHeight||document.body.clientHeight) - 80));">
    <div class="main">
      ...
      <tr>
       ...
       <td width="25%" class="dom"><input type="text" id="gpAddr" name="gpAddr" value="${object_gp1.gpAddr}"/></td>
      </tr>
      <tr>
       <td width="15%" class="label">通讯端口：</td>
       <td width="25%" class="dom"><input type="text" id="port" name="port" value="${object_gp1.port}"/></td>
      ...
      <tr>
         <td width="34%"  colspan="2" align="center">
            <input type="checkbox" id="sucratCptId" name="sucratCptId" value="${object_gp1.sucratCptId!="" ? "1" : "0"}" ${object_gp1.sucratCptId==1 ? "checked" : ""}>功率累计&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" id="computeFlag" name="computeFlag" value="${object_gp1.computeFlag!="" ? "1" : "0"}" ${object_gp1.computeFlag==1 ? "checked" : ""}/>电量累计
         </td>
      </tr>
     </table>
    </div>
      ...
      <div class="data3_con">
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td class="dom">
                  <peis:selectlist name="termProtocolNo" sql="SL_ARCHIVE_0086" />
                </td>
