...
function WebFXCheckBoxLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sOpen) {
	// call super
	this.WebFXTree = WebFXTree;
	this.WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon, sOpen);
...
function WebFXLoadCheckBoxTreeItem(sText, sValue, sAction, sXmlSrc, eParent, sIcon, sOpenIcon, bChecked, disabled) {
	// call super	
	...
	this.base(sText, sValue, sAction,  eParent, sIcon, sOpenIcon, bChecked, disabled);
...
function checkbox_createNode(oNode, parentDisabled){
	...
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadCheckBoxTreeItem(text, value, action, src, parent, icon, openIcon, checked, disabled);
	else
		jsNode = new WebFXCheckBoxTreeItem(text, value, action, parent, icon, openIcon, checked, disabled);
   
    // 将选中的值加入结果集中.
	if(checked){
		checkedValues.put(jsNode.id,  new CheckedObject(jsNode.id, text, value));
	}
