 ...
 * @author Thinkpad
 */
public class ECCURV_DataStoredProcedure extends StoredProcedure {
    ...
    public ECCURV_DataStoredProcedure(){
        
    }

    public ECCURV_DataStoredProcedure(DataSource dataSource) {
